...
function onCreatePost()
    ...
    --card
	makeLuaSprite('ecstaticCard', 'ecstaticCard', 80, 420);
	setScrollFactor('ecstaticCard', 1.1, 1.1);
	scaleObject('ecstaticCard', 1.7, 1.7);
	setObjectCamera('ecstaticCard','hud')
	addLuaSprite('ecstaticCard', true);
    ...
    --emotions
	makeLuaSprite('ECSTATIC', 'ECSTATIC', 80, 420);
	...
	--neutral
    makeAnimatedLuaSprite('KappaECSTATIC','OmoriHealthHeads/KappaECSTATIC', 5, 135);
    addAnimationByPrefix('KappaECSTATIC','Anime','Pico',24,true);
    scaleObject('KappaECSTATIC', 0.9, 0.9);
    objectPlayAnimation('KappaECSTATIC','Anime',false);
    setObjectCamera('KappaECSTATIC','hud')
	

	
	
	--sprites
	addLuaSprite('ECSTATIC', false);
    addLuaSprite('KappaECSTATIC', false);

...
function onCreatePost()
    ...
    --card
	makeLuaSprite('card', 'card', 80, 420);
	...
	--neutral
    makeAnimatedLuaSprite('SunnyNeutralCalm','OmoriHealthHeads/SunnyNeutralCalm', 5, 135);
    addAnimationByPrefix('SunnyNeutralCalm','Anime','Pico',24,true);
    scaleObject('SunnyNeutralCalm', 0.9, 0.9);
    objectPlayAnimation('SunnyNeutralCalm','Anime',false);
    setObjectCamera('SunnyNeutralCalm','hud')
    ...
    addLuaSprite('SunnyNeutralCalm', false);

...
function onCreate()
    ...
    makeAnimatedLuaSprite('KappaOmoHead','OmoriCreditsHeads/KappaOmoHead', 5, getProperty('bgThing.x') + 510, 850);
    addAnimationByPrefix('KappaOmoHead','Anime','Pico',24,true);
    scaleObject('KappaOmoHead', 0.9, 0.9);
    objectPlayAnimation('KappaOmoHead','Anime',false);
    setObjectCamera('KappaOmoHead','other')
    addLuaSprite('KappaOmoHead', false);
...
function onTweenCompleted(tag)
    if tag == 'bgThingLeave' then
        ...
        removeLuaSprite('KappaOmoHead', true)
...
function onUpdate()
    ...
    setProperty('KappaOmoHead.x', getProperty('bgThing.x') + 200)

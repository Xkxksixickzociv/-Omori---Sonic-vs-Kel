...
function onCreate()
    ...
    makeAnimatedLuaSprite('HEADSPACEKappaOmoHead','OmoriCreditsHeads/HEADSPACEKappaOmoHead', 5, getProperty('bgThing.x') + 510, 850);
    addAnimationByPrefix('HEADSPACEKappaOmoHead','Anime','Pico',24,true);
    scaleObject('HEADSPACEKappaOmoHead', 0.9, 0.9);
    objectPlayAnimation('HEADSPACEKappaOmoHead','Anime',false);
    setObjectCamera('HEADSPACEKappaOmoHead','other')
    addLuaSprite('HEADSPACEKappaOmoHead', false);
    ...
    setObjectOrder('HEADSPACEKappaOmoHead', 2)
end
...
function onTweenCompleted(tag)
    if tag == 'bgThingLeave' then
        ...
        removeLuaSprite('HEADSPACEKappaOmoHead', true)
...
function onUpdate()
    setProperty('beforeSongText.x', getProperty('bgThing.x') + 50)
    setProperty('songText.x', getProperty('bgThing.x') + 70)
    setProperty('HEADSPACEKappaOmoHead.x', getProperty('bgThing.x') + 200)
    setProperty('optionalText.x', getProperty('bgThing.x') + 360)
    setProperty('whoDuntIt.x', getProperty('bgThing.x') + 100)
end

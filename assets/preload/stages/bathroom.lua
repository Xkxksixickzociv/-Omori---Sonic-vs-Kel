...
function onCreate()
    ...
    makeLuaSprite('BackWall', 'bathroom/backWall', -650, -800);
    setScrollFactor('BackWall', 0.7, 1.0);
    scaleObject('BackWall', 1.0, 1.0);
    
	makeLuaSprite('BathroomSink', 'bathroom/sink', -1000, -800);

	-- sprites that only load if Low Quality is turned off
	if not lowQuality then
        
         makeLuaSprite('BathroomDim', 'bathroom/dim', -1000, -800);

	end

    addLuaSprite('BackWall', false);
    addLuaSprite('BathroomSink', true);
    addLuaSprite('BathroomDim', true);
